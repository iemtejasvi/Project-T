...
const RISK_TERMS: RiskTerm[] = [
  ...
  },
  {
    ...
    terms: [
      ...
      'grape', 'graped', 'graping', 'sexual assault',
  ...
  },
  {
    ...
    terms: [
      ...
      'unalive myself', 'unalive yourself', 'unalive themselves',
      'want to die', 'i want to die', 'i wanna die', 'you should die',
      'go die', 'hope you die', 'wish you died', 'drop dead',
      'cut myself', 'cut yourself',
      'catch the bus', 'anorexia', 'bulimia', 'pro ana', 'pro-ana',
      'pro mia', 'pro-mia', 'thinspo', 'bonespo',
    ],
  },
  {
    category: 'violence_or_extremism',
    terms: [
      'murder', 'murdered', 'murderer', 'kill you', 'kill them',
      'kill him', 'kill her', 'kill everyone', 'i will kill',
      'going to kill', 'want to kill', 'shoot you', 'shoot them',
      'shoot him', 'shoot her', 'school shooting', 'mass shooting',
      'bomb threat', 'make a bomb', 'bombing',
