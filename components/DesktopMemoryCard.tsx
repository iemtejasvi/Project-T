  ...
  return (
    <div className={`relative group ${large ? 'my-2' : 'my-0'}`}>
      <motion.div
        ...
        className={`flip-card relative w-full min-h-[380px] h-[440px] perspective-1000 ${flipped ? "cursor-grab active:cursor-grabbing" : "cursor-pointer"} rounded-[2rem] hover:shadow-2xl mx-auto`}
