...
const TypewriterPrompt: React.FC<{ tag?: string; subTag?: string; typewriterEnabled?: boolean }> = ({ tag, subTag, typewriterEnabled }) => {
  ...
  return (
    <div className="min-h-[2rem] overflow-hidden text-center text-xl text-[#000000] font-serif transition-all duration-300 whitespace-pre-wrap break-normal hyphens-auto">
      {displayedText}
    </div>
  );
};
        ...
        >
          ...
          >
            ...
            <div className="pb-1 relative z-10">
               <h3 className={`${large ? 'text-4xl' : 'text-2xl'} font-normal text-[#000000] flex items-center gap-2 leading-tight`}>
              ...
              {memory.sender && <p className={`mt-1 ${large ? 'text-3xl' : 'text-2xl'} italic text-[#000000] break-words overflow-hidden`}>From: {memory.sender}</p>}
              <hr className="my-2 border-[#000000]" />
            </div>
            <div className="text-xl text-[#000000] text-center font-normal relative z-10">
              {dateStr} | {dayStr}
            </div>
            <div className="text-xl min-h-[2.5em] mt-2 font-serif text-center text-[#000000] relative z-10">
          ...
          >
            ...
            <p className={`hidden lg:block text-4xl italic text-[#000000] text-center font-normal !font-normal relative z-10`}>if only i sent this</p>
            <p className={`block lg:hidden ${large ? 'text-3xl' : 'text-xl'} italic text-[#000000] text-center font-normal !font-normal relative z-10`}>if only i sent this</p>
