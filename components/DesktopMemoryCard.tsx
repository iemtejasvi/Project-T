  ...
  return (
    <div className={`relative group ${large ? 'my-2' : 'my-0'}`}>
      <motion.div
        ...
        className={`flip-card relative overflow-hidden w-full h-[460px] perspective-1000 ${flipped ? "cursor-grab active:cursor-grabbing" : "cursor-pointer"} rounded-[2rem] hover:shadow-2xl mx-auto`}
