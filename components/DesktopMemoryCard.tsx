    ...
    <div className={`relative group ${large ? 'my-2' : 'my-6'}`}>
      ...
      <div className="hidden lg:flex absolute -bottom-3 left-1/2 -translate-x-1/2 z-20 pointer-events-none">
        <Link href={`/memories/${memory.id}`} className="open-card-btn pointer-events-auto">
          <span className="inline-flex items-center rounded-full transition-all duration-300 bg-[var(--card-bg)]/80 text-[var(--text)]/80 backdrop-blur-sm border border-transparent text-[14px] leading-none px-0 py-0 w-0 h-0 opacity-0 group-hover:px-4 group-hover:py-[6px] group-hover:w-auto group-hover:h-auto group-hover:opacity-100 group-hover:border-[var(--border)]/70">
