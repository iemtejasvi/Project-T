...
const BleedingText: React.FC<BleedingTextProps> = ({ message, textClass }) => {
  return (
    <div className="bleeding-text-container">
      <svg>
        <filter id="cracked">
          <feGaussianBlur stdDeviation=".5" in="SourceGraphic" result="B" />
          <feTurbulence result="T" numOctaves="7" seed="488" baseFrequency=".042" />
          ...
          <feComposite in2="C" operator="arithmetic" k1="2.5" k2="-.5" k3="1" in="S" result="C" />
          ...
          <feSpecularLighting specularExponent="15" specularConstant=".8" surfaceScale="4" result="S" in="B">
