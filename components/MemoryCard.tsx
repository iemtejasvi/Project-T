  ...
  return (
    <div className="relative group my-4 sm:my-6">
      ...
      <motion.div
        ...
        className={`flip-card relative overflow-hidden ${variant === "home" ? "w-[40rem] sm:w-full" : "w-full"} ${variant === "home" ? "max-w-none" : "max-w-xs"} sm:max-w-sm mx-auto perspective-1000 h-[300px] cursor-pointer ${variant === "home" ? "rounded-[1.75rem]" : "rounded-[2rem]"} hover:shadow-[0_25px_50px_rgba(0,0,0,0.08)] transition-shadow duration-300`}
