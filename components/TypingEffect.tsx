...
const TypingEffect: React.FC<TypingEffectProps> = ({ className }) => {
  ...
  return (
    <div
      ...
      className={
        "min-h-[2.5rem] overflow-hidden text-center text-base sm:text-xl md:text-4xl font-serif font-normal text-[var(--text)] whitespace-pre-wrap break-normal hyphens-auto" +
        (className ? " " + className : "")
      }
    >
      {displayText}
