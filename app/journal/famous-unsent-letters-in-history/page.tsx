        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          <article className="bg-[var(--card-bg)] p-6 sm:p-10 rounded-xl shadow-lg border border-[var(--border)] lg:shadow-sm lg:border-transparent editorial-prose text-[var(--text)]">
            ...
            <p className="text-base sm:text-lg">
              ...
              with complete emotional exposure: &ldquo;My angel, my all, my very self , only a few words today, and
              indeed with pencil , Why this deep sorrow, where necessity speaks?&rdquo; The letter reveals a Beethoven
