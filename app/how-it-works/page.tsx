      ...
      <header className="bg-[var(--card-bg)] shadow-md">
        <div className="max-w-5xl mx-auto px-4 py-6 sm:px-6 sm:py-8 text-center">
          ...
          <nav className="relative inline-block">
            ...
            {dropdownOpen && (
              <div className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-48 bg-[var(--card-bg)] border border-[var(--border)] rounded shadow-lg z-10">
                <Link href="/contact">
                  <div className="px-4 py-2 hover:bg-[var(--accent)] hover:text-[var(--text)] transition-colors cursor-pointer">Contact</div>
                </Link>
                <Link href="/privacy-policy">
                  <div className="px-4 py-2 hover:bg-[var(--accent)] hover:text-[var(--text)] transition-colors cursor-pointer">Privacy Policy</div>
                </Link>
                <Link href="/donate">
                  <div className="px-4 py-2 hover:bg-[var(--accent)] hover:text-[var(--text)] transition-colors cursor-pointer">Donate</div>
                </Link>
              </div>
            )}
          </nav>
