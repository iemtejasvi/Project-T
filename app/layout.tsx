...
export const metadata = {
  ...
  keywords: [
    ...
    'breakup letter', 'letter after breakup', 'i miss my ex',
    'dear ex letter', 'moving on letter', 'letting go letter',
    'letter to my first love', 'open when letters',
    'grief letter', 'letter to someone who died', 'letter to heaven',
    'i never got to say goodbye', 'things I wish I said before you died',
    'letter to my best friend', 'letter to my toxic ex',
    'no contact letter', 'final goodbye letter', 'breakup closure',
    'letter to the one I lost', 'i still think about you',
    'anonymous breakup confession', 'heartbreak letters',
    'letter to my soulmate', 'unrequited love letter',
    'writing therapy', 'expressive writing', 'emotional release writing',
  ],
  other: {
