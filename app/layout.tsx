...
export const metadata = {
  ...
  keywords: [
    ...
    // Emotional quotes & expressions
    "feelings quotes for when you can't speak",
    "unsaid words quotes",
    "deep emotional quotes",
    "quotes about missing someone",
    "sad love quotes",
    "healing heart quotes",
    "quotes for lonely nights",
    "anxiety expression quotes",
    "emotional farewell quotes",
    "motivational healing quotes",
    // Feelings & emotions
    "feelings by color chart",
    "emotional color associations",
    "anger feeling chart",
    "color coded emotions",
    "feelings word list",
    "happy feelings synonyms",
    "sadness expression words",
    ...
    "coping with heartbreak writing",
    "mental health confession",
    "anxiety journal prompts",
    "healing through letters",
    "emotional wellness writing",
    "self care writing prompts",
    "therapy writing exercises",
    // Gen Z & trending
    "tiktok confession trend",
    "viral love quote tiktok",
    "gen z heartbreak songs",
    "millennial love memes",
    "trending breakup advice",
    "influencer confessions",
    "pop culture confession",
    "relatable confession reel",
    "rizz meaning love",
    "modern slang emotions",
    // Seasonal & cultural themes
    "christmas breakup story",
    "valentines day unsent confession",
    "new year closure letter",
    "holiday heartbreak notes",
    "summer love confessions",
    "fall nostalgia messages",
    "cultural love diary",
    "festive season regrets",
    "seasonal confession themes",
    "holiday love messages",
    // Music & pop culture keywords
    "taylor swift lyric letter",
    "olivia rodrigo confession",
    "heartbreak song quotes",
    "music inspired confessions",
    "famous breakup song lyrics",
    ...
    "subreddit unsent messages",
    "sharing secrets site",
    "public anonymous diary",
    "social media confession",
    "support group stories",
    "memory archive website",
    "interactive confession board",
